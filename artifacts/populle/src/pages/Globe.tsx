...
export default function Globe() {
  ...
  return (
    <Layout>
      <SEO
        title="World Population 3D Globe | Populle"
        description={`Explore world population on an interactive 3D globe. See population data for ${data?.totalCountries || 170}+ countries in year ${year}.`}
        keywords="3D globe, world population, interactive map, population visualization"
        path="/globe"
