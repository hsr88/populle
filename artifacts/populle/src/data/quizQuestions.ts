...
export const quizQuestions: QuizQuestion[] = [
  ...
  { id: 35, type: 'comparison', question: 'Who has more people: Nigeria or Brazil?', options: ['Nigeria', 'Brazil', 'Equal', 'Cannot determine'], correctAnswer: 1, explanation: 'Brazil (~215M) vs Nigeria (~223M)' },
  ...
  { id: 42, type: 'comparison', question: 'Which has more people: Kenya or South Africa?', options: ['Kenya', 'South Africa', 'Equal', 'Cannot determine'], correctAnswer: 0, explanation: 'Kenya (~54M) vs South Africa (~60M) - actually SA is larger!' },
